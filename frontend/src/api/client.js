...
const postRoutes = {
  ...
  deleteVendor: ["DELETE", p => `/vendors/${p.VendorID}`],
  ...
  deleteLLPPayable: ["DELETE", p => `/payables/${p.PayableID}`],
  ...
  reimbursePayable: ["POST", p => `/payables/${p.PayableID}/reimburse`],
  ...
  deleteNeoInvoice: ["DELETE", p => `/neo-invoices/${p.NeoInvoiceID}`],
  saveBankAccount: ["POST", "/bank-accounts"],
  updateBankAccount: ["PUT", p => `/bank-accounts/${p.AccountID}`],
  deleteBankAccount: ["DELETE", p => `/bank-accounts/${p.AccountID}`],
